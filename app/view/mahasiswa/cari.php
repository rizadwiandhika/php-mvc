    ...
    <div class="row">
        <div class="col-lg-6">
            <form action="<?= BASEURL ?>mahasiswa/cari" method="post">
                ...
                <input type="text" class="form-control" id="keyword" name="keyword" autocomplete="off" value="<?= $data['keyword'] ?> ">
                <div class="input-group-append" id="button-addon4">
                    <a href="<?=BASEURL?>mahasiswa" class="btn btn-outline-secondary" style="width: 74.781px;">reset</a>
